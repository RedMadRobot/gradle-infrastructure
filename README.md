...
```kotlin
plugins {
    id("com.redmadrobot.kotlin-library") version "0.16"
    id("com.redmadrobot.publish") version "0.16"
    id("com.redmadrobot.detekt") version "0.16"
    id("com.redmadrobot.application") version "0.16"
    id("com.redmadrobot.android-library") version "0.16"
}
```
